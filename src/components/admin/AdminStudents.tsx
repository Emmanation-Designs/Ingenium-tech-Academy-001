    ...
    return (
      <div className="space-y-4 pb-20 max-w-xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-gray-100/90 p-5 shadow-xs flex flex-col items-center text-center">
          <div className="w-16 h-16 rounded-full bg-[#EAFBF3] border-2 border-[#00B074]/30 flex items-center justify-center text-[#00B074] font-black text-xl mb-3 shadow-xs">
          ...
          <div className="flex items-center justify-center gap-3 mt-3 text-xs text-gray-600 flex-wrap">
            <span className="flex items-center gap-1 font-semibold">
              <span>{getCountryFlag(selectedStudent.country)}</span>
        ...
        {activeDetailTab === 'activity' && (
          <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-xs space-y-3 text-xs">
            <div className="flex gap-3 items-start">
              <div className="w-2 h-2 rounded-full bg-[#00B074] mt-1.5" />
              <div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 text-right">
                  <div>
                    <div className="flex items-center gap-1 justify-end text-xs font-semibold text-gray-800">
